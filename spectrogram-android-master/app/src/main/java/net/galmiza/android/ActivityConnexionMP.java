...
public class ActivityConnexionMP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connexion_mp);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (identifiant.getText().toString().equals("admin") && password.getText().toString().equals("1234")) {
                    Intent intent = new Intent(ActivityConnexionMP.this, ActivityChoixAjout.class);
        ...
        imgbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ActivityConnexionMP.this, Activity_Accueil.class);
                startActivity(i);
